            ...
            <div class="container">
              <div class="row mb-5 justify-content-center">
                <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
                  <h2 class="section-title"  style="color:white"  >BULLETIN L2</h2>
                  ...
                  $matiere=['Algorithme 2','Recherche Operationnel','Uml','Php','C#','Statistique/Probabilite ','Technique de communication'];
                  $coeff=[3,4,3,4,4,4,2]; 
