  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300"
   style="background-image:url(images/background.jpg)">
      ...
      <div class="site-wrap">
          ...
          <?php
          //  $texte = file_get_contents('compte.txt');
          //   $texte+=1 ;
          //   file_put_contents('compte.txt',$texte);
        ?>
            ...
            <div class="container">
              <div class="row mb-5 justify-content-center">
                <div class="col-lg-7 text-center"  data-aos="fade-up" data-aos-delay="">
                  <h2 class="section-title"  style="color:white"  >BULLETIN L1</h2>
                  <a class= "btn btn-dark" href="bulletin2.php">Licence 2</a>
                  <a class= "btn btn-dark" href="bulletin3.php">Licence 3</a>
                </div>
                  ...
                  $matiere=['Analyse','Algèbre','Architecture des ordinateur','Php','Python','Algorithme','Technique de communication'];
                  $coeff=[3,3,3,4,4,3,2]; 
                  ...
                  <tr>
                    ...
                    <a  class="btn btn-dark"href="fichier.pdf">PDF</a></td>
                  </tr>
                  </theed> 
                  </table>
                      </div>
